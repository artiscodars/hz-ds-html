 ...
 * License: MIT
 * 
 * Modified to fit our need for the demo in VUD library
 */
(function () {
    'use strict';
    ...
    var Timepicker = /*#__PURE__*/function () {
      ...
      _createClass(Timepicker, [{
        ...
        value: function _selectValue() {
          ...
          tp.settings;
          var list = tp.list;
          var cursor = list.find(".selected");
  
          if (cursor.hasClass("timepicker-disabled")) {
            return false;
          }
        ...
        value: function hideAll() {
          var _iterator3 = _createForOfIteratorHelper(document.getElementsByClassName('timepicker-input')),
              _step3;
    ...
    (function (factory) {
      ...
      var methods = {
        init: function init(options) {
          return this.each(function () {
            ...
            self.addClass("timepicker-input");
        ...
        show: function show(e) {
          ...
          if (verticalOrientation == "t") {
            ...
            list.addClass("timepicker-positioned-top");
            listOffset.top = self.offset().top - list.outerHeight() + parseInt(list.css("marginTop").replace("px", ""), 10);
          } else {
            // put it under the input
            list.removeClass("timepicker-positioned-top");
          ...
          if (!selected.length || selected.hasClass("timepicker-disabled")) {
            selected = list.find("li:not(.timepicker-disabled):first");
          }
          ...
          if (settings.stopScrollPropagation) {
            $(document).on("wheel.ui-timepicker", ".dropdown-menu", function (e) {
              e.preventDefault();
        ...
        remove: function remove() {
          ...
          if (!self.hasClass("timepicker-input")) {
            return;
          }
          ...
          self.removeClass("timepicker-input");
      ...
      function _render(self) {
        ...
        if (settings.useSelect) {
          ...
          if (self.attr("name")) {
            list.attr("name", "timepicker-" + self.attr("name"));
          }
        ...
        if ((settings.minTime !== null || settings.durationTime !== null) && settings.showDuration) {
          ...
          wrapped_list.addClass("timepicker-with-duration");
          wrapped_list.addClass("timepicker-step-" + settings.step);
        }
        ...
        for (var i = start, j = 0; i <= end; j++, i += stepFunc(j) * 60) {
          ...
          if (settings.useSelect) {
            ...
            var row = $("<li tabindex='1'><a></a></li>");
            row.addClass(timeInt % ONE_DAY < ONE_DAY / 2 ? "timepicker-am dropdown-item" : "timepicker-pm dropdown-item");
          ...
          if (drCur < drLen) {
            ...
            if (dr[drCur] && timeInt >= dr[drCur][0] && timeInt < dr[drCur][1]) {
              if (settings.useSelect) {
                ...
                row.addClass("timepicker-disabled");
              }
            }
          }
      ...
      function _closeHandler(e) {
        ...
        if (target.closest(".timepicker-input").length || target.closest(".dropdown-menu").length) {
      ...
      function _keydownhandler(e) {
        ...
        switch (e.keyCode) {
          ...
          case 40:
            // down
            selected = list.find(".focus"); // old: selected = list.find(".selected");
            ...
            if (selected.length === 0) {
              ...
              selected.addClass("focus"); // old: selected.addClass("selected");
            } else if (!selected.is(":last-child")) {
              selected.removeClass("focus"); // old: selected.removeClass("selected");
              selected.next().addClass("focus"); // old: selected.next().addClass("selected");
          ...
          case 27:
            // escape
            list.find("li").removeClass("focus"); // old: list.find("li").removeClass("selected");
            tp.hideMe();
            break;
      ...
      $.fn.timepicker = function (method) {
        ...
        if (methods[method]) {
          ...
          if (!this.hasClass("timepicker-input")) {
            return this;
          }
